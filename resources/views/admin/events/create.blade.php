            ...
            <form method="POST" action="{{ route('events.store') }}">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="date" name="event_date" class="w-full rounded-md border-gray-300 shadow-sm"
                            required>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="time" name="start_time" class="w-full rounded-md border-gray-300 shadow-sm"
                            required>
                    </div>
                    <div>
                        <label class="block text-gray-700 text-sm font-bold mb-2">End Time</label>
                        <input type="time" name="end_time" class="w-full rounded-md border-gray-300 shadow-sm"
                            required>
                    </div>
                    <div>
                        <label class="block text-gray-700 text-sm font-bold mb-2">Max Slots</label>
                        <input type="number" name="maximum_slots" class="w-full rounded-md border-gray-300 shadow-sm"
                            required>
                    </div>
                    <div>
