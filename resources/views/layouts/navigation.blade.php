<nav x-data="{ open: false }" class="bg-white border-b border-orange-50/60 sticky top-0 z-50 shadow-sm">
    <div class="px-4 md:px-8 py-4 flex items-center justify-between w-full">
        ...
        <div class="flex items-center gap-2.5">
            <a href="{{ auth()->check() ? route('dashboard') : route('student.home') }}"
        ...
        <div class="hidden md:flex items-center">
            ...
            @guest
                <div class="flex items-center gap-2">
                    <a href="{{ route('login') }}"
                        class="px-5 py-2 text-sm font-semibold text-gray-700 rounded-full border border-gray-200 hover:bg-gray-50 transition-colors">Log
                        in</a>
                    <a href="{{ route('register') }}"
                        class="px-5 py-2 text-sm font-bold text-white bg-[#FF7A00] rounded-full hover:bg-orange-600 shadow-sm transition-all">Sign
                        up</a>
                </div>
            @endguest
        </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden md:hidden border-t border-gray-100 bg-white">
        ...
        @guest
            <div class="pt-4 pb-4 border-t border-gray-200 px-4 space-y-2">
                <a href="{{ route('login') }}"
                    class="block w-full text-center px-4 py-2.5 text-sm font-semibold text-gray-700 rounded-full border border-gray-200 hover:bg-gray-50 transition-colors">Log
                    in</a>
                <a href="{{ route('register') }}"
                    class="block w-full text-center px-4 py-2.5 text-sm font-bold text-white bg-[#FF7A00] rounded-full hover:bg-orange-600 shadow-sm transition-all">Sign
                    up</a>
            </div>
        @endguest
    </div>
